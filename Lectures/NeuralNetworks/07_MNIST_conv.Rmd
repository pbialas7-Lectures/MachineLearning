...
<!-- #region {"slideshow": {"slide_type": "slide"}} -->
$$O_{i,j} =\displaystyle \sum_{k,l=0}^{K-1} w_{c,k,l}\times I_{c,-P_i+i+k, -P_i+j+l}+b$$

$$i = 0,\ldots,H_i-2 P_i, \;j = 0,\ldots,W_i-2 P_i$$
<!-- #endregion -->
...
<!-- #region {"slideshow": {"slide_type": "fragment"}} -->
$$O_{c,i,j} = \sum_{c^\prime=0}^{C_i-1} \displaystyle \sum_{k,l=0}^{K-1} w_{c,c^\prime k,l}I_{c^\prime,-P_i+i+k, -P_i+j+l}+b_{c}$$
$$\qquad c=0,\ldots C_o-1,\;i = 0,\ldots,H_i-2 P_i, \;j = 0,\ldots,W_i-2 P_i$$
<!-- #endregion -->
