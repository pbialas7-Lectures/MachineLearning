...
<!-- #region tags=["answer"] editable=true slideshow={"slide_type": "skip"} -->
It follows directly from the second and third axiom after noting that
<!-- #endregion -->

<!-- #region tags=["answer"] editable=true slideshow={"slide_type": "slide"} -->
...
<!-- #region slideshow={"slide_type": "slide"} tags=["answer"] editable=true -->
...
```{python tags=c("answer"), editable=TRUE, slideshow={'slide_type': 'fragment'}}
p_ill_cond_p = 0.8  
```
...
<!-- #region tags=["answer"] editable=true slideshow={"slide_type": "fragment"} -->
