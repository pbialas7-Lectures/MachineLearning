...
cars_data = pd.read_csv("../../Data/Cars/car_data.csv", 
...
train_encoded = pd.DataFrame(features_encoder.transform(cars_train), 
...
```{python editable=TRUE, slideshow={'slide_type': 'slide'}}
test_encoded = pd.DataFrame(features_encoder.transform(cars_test), 
                            columns=features_encoder.get_feature_names_out())
...
<!-- #region slideshow={"slide_type": "fragment", "slideshow": {"slide_type": "slide"}} editable=true -->
...
<!-- #region slideshow={"slide_type": "slide"} tags=["problem"] editable=true -->
#### Problem
<!-- #endregion -->

<!-- #region slideshow={"slide_type": "-"} tags=["problem"] editable=true -->
