...
<!-- #region {"slideshow": {"slide_type": "notes"}, "tags": ["text"], "editable": true} -->
...
<!-- #region {"tags": ["answer"], "slideshow": {"slide_type": "skip"}, "jupyter": {"source_hidden": true}} -->
This is not necessary but I will  define a function that creates a desired probability distribution:
<!-- #endregion -->

```{python tags=c("answer"), slideshow={'slide_type': 'slide'}, jupyter={'source_hidden': True}}
...
<!-- #region {"tags": ["answer"], "slideshow": {"slide_type": "notes"}, "jupyter": {"source_hidden": true}} -->
...
```{python tags=c("answer"), slideshow={'slide_type': 'skip'}, jupyter={'source_hidden': True}}
TPR = 0.8
FPR =0.1
PP = 0.004
PN = 1-PP
